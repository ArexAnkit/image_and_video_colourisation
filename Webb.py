...
def render_sidebar_author():
    st.sidebar.title("Authors")
    st.sidebar.markdown("Ankit Aman")
    st.sidebar.markdown("Abhinav Prakash")
    st.sidebar.markdown("Bishwajit Paul")
    st.sidebar.markdown("Charan Kumar K")

def render_image_colorization():
...
def render_video_colorization():
    ...
    if video_file is not None:
        ...
        stframe = st.empty()
        while vf.isOpened():
            # Video colorization loop code here
                ret, frame = vf.read()
